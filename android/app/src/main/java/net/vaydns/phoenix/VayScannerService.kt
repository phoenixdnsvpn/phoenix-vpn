...
class VayScannerService : Service() {
    ...
    override fun onCreate() {
        ...
        try {
            ...
            wakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Phoenix::ScannerServiceWakelock")
            wakeLock?.acquire()
        } catch (e: Exception) {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val notification = NotificationCompat.Builder(this, "VAY_SCANNER_CHANNEL")
            .setContentTitle("Phoenix Scanner Running")
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(
                "VAY_SCANNER_CHANNEL", "Phoenix Scanner", NotificationManager.IMPORTANCE_LOW
            )
