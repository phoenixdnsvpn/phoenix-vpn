...
import net.vaydns.phoenix.AppInfo
import net.vaydns.phoenix.R

class AppAdapter(
    private val context: Context,
    private var apps: List<net.vaydns.phoenix.AppListItem>,
    ...
    fun updateList(newApps: List<net.vaydns.phoenix.AppListItem>) {
        this.apps = newApps
        notifyDataSetChanged()
    }

    fun updateSelectedApps(newSelected: Set<String>) {
        savedApps.clear()
        savedApps.addAll(newSelected)
        notifyDataSetChanged()
    }
}